namespace RoomBuildingStarterKit.BuildSystem
{
    ...
    public class WallFurnitureEntity : FurnitureEntityBase
    {
        ...
        public WallFurnitureEntity(FloorEntity floorEntity, List<FloorEntity> floorEntities, short direction, FurnitureType furnitureType, GameObject furniture, GameObject parentRoom) : base(furnitureType, furniture, direction, floorEntity, parentRoom)
        {
            this.FloorEntities = floorEntities;
        }
        ...
        /// <param name="furniture">The furniture gameObject.</param>
        /// <param name="customProperties">The custom properties.</param>
        public WallFurnitureEntity(FloorEntity floorEntity, List<FloorEntity> floorEntities, short direction, FurnitureType furnitureType, GameObject furniture, GameObject parentRoom, FurnitureCustomPersistentProperties customProperties) : base(furnitureType, furniture, direction, floorEntity, parentRoom, customProperties)
        {
            this.FloorEntities = floorEntities;
        }
