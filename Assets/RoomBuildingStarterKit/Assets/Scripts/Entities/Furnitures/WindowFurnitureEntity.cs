namespace RoomBuildingStarterKit.BuildSystem
{
    ...
    public class WindowFurnitureEntity : WallFurnitureEntity
    {
        ...
        public WindowFurnitureEntity(FloorEntity floorEntity, short direction, FurnitureType furnitureType, GameObject furniture, GameObject parentRoom) : base(floorEntity, new List<FloorEntity> { floorEntity }, direction, furnitureType, furniture, parentRoom)
        {
        }
    }
}