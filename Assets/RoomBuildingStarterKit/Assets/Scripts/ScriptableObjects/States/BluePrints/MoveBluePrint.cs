    ...
    public class MoveBluePrint : BluePrintState
    {
        ...
        protected override void OnExit()
        {
            ...
            if (floorEntity != null)
            {
                ...
                // Offsets payed floors.
                this.BluePrint.PayedFloorEntities = this.BluePrint.PayedFloorEntities.Select(f => this.BluePrint.FoundationManager.OfficeFloorCollection.GetOfficeFloor(MoveBluePrint.TransformAndRotate(offsetX, offsetZ, this.direction, f, this.BluePrintData.MoveBluePrintRelativeFloor)).FloorEntity).ToList();
