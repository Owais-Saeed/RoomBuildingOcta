namespace RoomBuildingStarterKit.Components
{
    ...
    public class MoveFurniture : ModifyFurnitureBase
    {
        ...
        protected override void PutDownFurniture(FloorEntity floorEntity, Vector3 targetPosition, Quaternion targetRotation, List<FloorEntity> occupiedFloorEntities)
        {
            ...
            this.BluePrint.BluePrintFurnitureEntities.Add(new GroundFurnitureEntity(floorEntity, occupiedFloorEntities, this.editingFurnitureDirection, this.editingFurniture.GetComponent<FurnitureController>().FurnitureType, this.editingFurniture, this.BluePrint.gameObject));
        ...
        protected override void PutDownWindow(FloorEntity floorEntity, short dir, Vector3 targetPosition, Quaternion targetRotation)
        {
            ...
            this.BluePrint.BluePrintWindowFurnitureEntities.Add(new WindowFurnitureEntity(floorEntity, dir, FurnitureType.Common_Window, this.editingFurniture, this.BluePrint.gameObject));
            this.editingFurniture = null;
            this.editingFurnitureType = -1;
        }
        ...
        protected override void PutDownWallFurniture(FloorEntity floorEntity, List<FloorEntity> floorEntities, short dir, Vector3 targetPosition, Quaternion targetRotation)
        {
            ...
            this.BluePrint.BluePrintWallFurnitureEntities.Add(new WallFurnitureEntity(floorEntity, floorEntities, dir, this.editingFurniture.GetComponent<FurnitureController>().FurnitureType, this.editingFurniture, this.BluePrint.gameObject));
            this.editingFurniture = null;
            this.editingFurnitureType = -1;
        }
    }
