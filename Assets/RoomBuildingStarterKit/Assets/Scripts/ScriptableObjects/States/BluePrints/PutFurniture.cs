namespace RoomBuildingStarterKit.Components
{
    ...
    public class PutFurniture : ModifyFurnitureBase
    {
        ...
        protected override void PutDownFurniture(FloorEntity floorEntity, Vector3 targetPosition, Quaternion targetRotation, List<FloorEntity> occupiedFloorEntities)
        {
            ...
            this.BluePrint.BluePrintFurnitureEntities.Add(new GroundFurnitureEntity(floorEntity, occupiedFloorEntities, this.editingFurnitureDirection, furniture.GetComponent<FurnitureController>().FurnitureType, furniture, this.BluePrint.gameObject));

            // Calculates cost.
            CurrencyController.inst.Increment -= furniture.GetComponent<FurnitureController>().PurchasePrice;
        }
        ...
        protected override void PutDownWindow(FloorEntity floorEntity, short dir, Vector3 targetPosition, Quaternion targetRotation)
        {
            ...
            this.BluePrint.BluePrintWindowFurnitureEntities.Add(new WindowFurnitureEntity(floorEntity, dir, FurnitureType.Common_Window, window, this.BluePrint.gameObject));

            if (CurrencyController.inst != null)
            {
                // Calculates cost.
                CurrencyController.inst.Increment -= window.GetComponent<FurnitureController>().PurchasePrice;
            }
        }
        ...
        protected override void PutDownWallFurniture(FloorEntity floorEntity, List<FloorEntity> floorEntities, short dir, Vector3 targetPosition, Quaternion targetRotation)
        {
            ...
            this.BluePrint.BluePrintWallFurnitureEntities.Add(new WallFurnitureEntity(floorEntity, floorEntities, dir, furniture.GetComponent<FurnitureController>().FurnitureType, furniture, this.BluePrint.gameObject));
