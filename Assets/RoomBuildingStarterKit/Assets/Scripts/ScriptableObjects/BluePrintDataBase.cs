namespace RoomBuildingStarterKit.BuildSystem
{
    ...
    public class BluePrintDataBase : ScriptableObject
    {
        ...
        /// <summary>
        /// Gets or sets the last frame add floor entities, used for calculating cost.
        /// </summary>
        public List<FloorEntity> LastFrameAddFloorEntities { get; set; }

        /// <summary>
        /// Gets or sets the last frame delete floor entities, used for calculating cost.
        /// </summary>
        public List<FloorEntity> LastFrameDeleteFloorEntities { get; set; }
        ...
        private void OnEnable()
        {
            ...
            this.LastFrameAddFloorEntities = null;
            this.LastFrameDeleteFloorEntities = null;
        }
    }
}