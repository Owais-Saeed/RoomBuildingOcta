namespace RoomBuildingStarterKit.Components
{
    ...
    public class RealRoom : MonoBehaviourPunCallbacks
    {
        /// <summary>
        /// The purchase price of a grid.
        /// </summary>
        public double PurchasePricePerGrid = 5;

        /// <summary>
        /// The sell price of a grid.
        /// </summary>
        public double SellPricePerGrid = 3;
        ...
        {
            photonView.RPC("BuildRealRoom", RpcTarget.AllBuffered);
        }
        ...
        private void BuildRealRoomFloors(List<FloorEntity> selectedFloorEntities)
        {
            ...
            foreach (var officeFloor in this.officeFloorCollection.OfficeFloors)
            {
                ...
                //PhotonNetwork.Instantiate(this.FloorPrefab.name, floor.transform.position, Quaternion.identity);
        ...
        private void BuildRealRoomBase(List<FloorEntity> selectedFloorEntities)
        {
            ...
            if (this.RealRoomContainer.transform.parent.name == "LoungeRoom(Clone)")
            {
                //rcpSetActive o = gameObject.AddComponent(typeof(rcpSetActive)) as rcpSetActive;
                //o.RPC_Test(this.RealRoomContainer.transform.parent.gameObject);

                PhotonView LoungeView = this.RealRoomContainer.transform.parent.gameObject.GetComponent<PhotonView>();
            ...
            //photonView.RPC("RPC_BuildRealRoomInnerWallsAroundFloor", RpcTarget.AllBuffered, selectedFloorEntities);
        ...
        //_____________________________________ For Multiplayer _____________________________________//

        [PunRPC]
        public void RPC_SetActive(int LoungeID)
        {
