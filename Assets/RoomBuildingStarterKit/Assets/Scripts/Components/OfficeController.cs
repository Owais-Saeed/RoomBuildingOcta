namespace RoomBuildingStarterKit.BuildSystem
{
    ...
    public class OfficeController : MonoBehaviour
    {
        ...
        public GameObject CreateNewRoom(RoomType roomType)
        {
            ...
            //
            //if (GlobalRoomManager.inst.RoomTypeToPrefabs[roomType].name == "LoungeRoom")
            //{
            //    room = PhotonNetwork.Instantiate(GlobalRoomManager.inst.RoomTypeToPrefabs[roomType].name, GlobalRoomManager.inst.RoomTypeToPrefabs[roomType].transform.position, Quaternion.identity);

            //    room.transform.SetParent(RoomsContainerTransform);
            //}
            //else
            //{
            //    room = Instantiate(GlobalRoomManager.inst.RoomTypeToPrefabs[roomType], this.RoomsContainerTransform);
