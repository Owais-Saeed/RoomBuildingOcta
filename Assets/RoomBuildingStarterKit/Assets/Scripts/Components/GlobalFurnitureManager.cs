namespace RoomBuildingStarterKit.BuildSystem
{
    ...
    public class GlobalFurnitureManager : Singleton<GlobalFurnitureManager>
    {
        ...
        /// <summary>
        /// Gets the office furniture entities.
        /// </summary>
        public List<GroundFurnitureEntity> OfficeFurnitureEntities { get => this.globalFurnitureManagerSerializableData.OfficeFurnitureEntities; }
        ...
        private void PutDownFurniture(FloorEntity floorEntity, Vector3 targetPosition, Quaternion targetRotation, List<FloorEntity> occupiedFloorEntities)
        {
            ...
            {
                CurrencyController.inst.Add(-furniture.GetComponent<FurnitureController>().PurchasePrice);
            ...
            var furnitureEntity = new GroundFurnitureEntity(floorEntity, occupiedFloorEntities, this.editingFurnitureDirection, furniture.GetComponent<FurnitureController>().FurnitureType, furniture, null);
        ...
        private void UpdateBuildOfficeFurniture()
        {
            ...
            if (floorEntity != null)
            {
                ...
                {
                    if (CurrencyController.inst.CanAfford(-this.editingFurniture.GetComponent<FurnitureController>().PurchasePrice) == false)
                    {
            ...
            {
                if (this.isMovingOfficeFurniture)
                {
                    CurrencyController.inst.Add(this.editingFurniture.GetComponent<FurnitureController>().SellPrice);
                }

                this.CancelBuildOfficeFurniture(false);
                return;
            }
        }
        ...
        public void BeginBuildOfficeFurniture()
        {
            ...
            // Pause NPCs when build office furniture.
        ...
        /// </summary>
        public void CancelBuildOfficeFurniture(bool continueNPC = true)
        {
            this.editingFurnitureType = -1;
            this.editingFurnitureDirection = 0;
            Destroy(this.editingFurniture);
        ...
        public void Assign(GlobalFurnitureManagerSerializableData globalFurnitureManagerSerializableData)
        {
            globalFurnitureManagerSerializableData.OfficeFurnitureEntities.ForEach(f =>
            {
                ...
                FurnitureHelper.ChangeFurnitureLayer(furniture, LayerMask.NameToLayer("Selectable"));
                var furnitureEntity = new GroundFurnitureEntity(floorEntity, floorEntities, f.Direction, f.FurnitureType, furniture, null, f.CustomProperties);
