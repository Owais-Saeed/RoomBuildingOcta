namespace RoomBuildingStarterKit
{
    ...
    public class OutlinePostEffect : Singleton<OutlinePostEffect>
    {
        ...
        /// <summary>
        /// The is force show outline or not.
        /// </summary>
        private bool isForceShowOutline;

        /// <summary>
        /// Force to show outline.
        /// </summary>
        public void ForceShowOutline()
        {
            this.isForceShowOutline = true;
        ...
        /// <summary>
        /// Cancels force show outline.
        /// </summary>
        public void CancelForceShowOutline()
        {
            this.isForceShowOutline = false;
        }
        ...
        {
            if (this.isForceShowOutline == true)
            {
                return;
            }
