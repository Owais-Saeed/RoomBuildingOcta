namespace RoomBuildingStarterKit.VisualizeDictionary.Implementations
{
    ...
    /// <summary>
    /// The visualize dictionary with <EmployeeType, GameObject> entry.
    /// </summary>
    [Serializable]
    public class EmployeeTypeEnumGameObjectDict : VisualizeDictionary<EmployeeTypeEnumGameObjectEntry, EmployeeType, GameObject>
    {
    }
}
