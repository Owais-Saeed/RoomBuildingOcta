...
IL_001c:
		{
			...
			VirtualActionInvoker1< uint8_t >::Invoke(31 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_9, (uint8_t)((int32_t)32));
			goto IL_006c;
		}
...
IL_0046:
		{
			...
			VirtualActionInvoker1< uint8_t >::Invoke(31 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_19, L_23);
			goto IL_006c;
		}
...
IL_0060:
		{
			...
			VirtualActionInvoker1< uint8_t >::Invoke(31 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_24, L_28);
		}
...
IL_007d:
		{
			...
			L_34 = VirtualFuncInvoker0< ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726* >::Invoke(35 /* System.Byte[] System.IO.MemoryStream::ToArray() */, L_33);
			V_5 = L_34;
