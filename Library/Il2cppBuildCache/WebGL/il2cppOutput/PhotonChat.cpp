...
IL_002b:
	{
		...
		uint8_t L_11;
		L_11 = ChatClient_get_TransportProtocol_m0E1DDBF005B247D22FC73BC950B629A5D6CD58D7(__this, /*hidden argument*/NULL);
	...
	{
		uint8_t L_12;
		L_12 = ChatClient_get_TransportProtocol_m0E1DDBF005B247D22FC73BC950B629A5D6CD58D7(__this, /*hidden argument*/NULL);
...
IL_0094:
	...
	}
	{
		...
		ChatClient_set_TransportProtocol_mA415DB4B8029C2D2534D7FC3CD1C0F2DE62218B6(__this, 5, /*hidden argument*/NULL);
	}
...
IL_00e1:
	...
	}
	{
		...
		uint8_t L_25;
		L_25 = SupportClass_StartBackgroundCalls_m4A82EFA21B9558D42C85D74EC213B7ED4DDBC11C(L_23, L_24, _stringLiteralDF6A7CB87243568376528ACED2E19B84FDCE6A7C, /*hidden argument*/NULL);
	}
...
IL_0038:
	{
		// if (this.TransportProtocol == ConnectionProtocol.Tcp || this.TransportProtocol == ConnectionProtocol.Udp)
		uint8_t L_5;
		L_5 = ChatClient_get_TransportProtocol_m0E1DDBF005B247D22FC73BC950B629A5D6CD58D7(__this, /*hidden argument*/NULL);
	...
	{
		uint8_t L_6;
		L_6 = ChatClient_get_TransportProtocol_m0E1DDBF005B247D22FC73BC950B629A5D6CD58D7(__this, /*hidden argument*/NULL);
...
IL_006d:
	{
		...
		bool L_11;
		L_11 = VirtualFuncInvoker4< bool, String_t*, String_t*, RuntimeObject *, RuntimeObject * >::Invoke(6 /* System.Boolean ExitGames.Client.Photon.PhotonPeer::Connect(System.String,System.String,System.Object,System.Object) */, L_9, L_10, _stringLiteral73442709295E0907BAB5FF689567842B1B7D4C01, NULL, NULL);
